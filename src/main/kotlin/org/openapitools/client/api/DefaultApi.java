...
public class DefaultApi {
    ...
    public okhttp3.Call deleteManifestsCall(String name, String reference, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/{name}/manifests/{reference}"
     ...
     */
    public okhttp3.Call nameTagsListGetCall(String name, Integer n, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/{name}/tags/list"
                .replaceAll("\\{" + "name" + "\\}", localVarApiClient.escapeString(name.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call nameTagsListGetValidateBeforeCall(String name, Integer n, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = nameTagsListGetCall(name, n, _callback);
        return localVarCall;
     ...
     */
    public Tags nameTagsListGet(String name, Integer n) throws ApiException {
        ApiResponse<Tags> localVarResp = nameTagsListGetWithHttpInfo(name, n);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Tags> nameTagsListGetWithHttpInfo(String name, Integer n) throws ApiException {
        okhttp3.Call localVarCall = nameTagsListGetValidateBeforeCall(name, n, null);
     ...
     */
    public okhttp3.Call nameTagsListGetAsync(String name, Integer n, final ApiCallback<Tags> _callback) throws ApiException {

        okhttp3.Call localVarCall = nameTagsListGetValidateBeforeCall(name, n, _callback);
        Type localVarReturnType = new TypeToken<Tags>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
